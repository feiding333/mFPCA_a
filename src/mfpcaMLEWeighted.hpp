#ifndef MFPCAMLEWEIGHTED_CLASS
#define MFPCAMLEWEIGHTED_CLASS
...
public:
    ...
    mfpcaMLEWeighted(vec y_, mat bMatLarge, 
    ...
    void set_covariateZ(vec covZ_, double h_){
        zCovariate = covZ_;
        h = h_;
    }
    void setNewZ(double);
...
private:
    // For weighted computation
    vec weights;
    vec zCovariate; 
    double h; // kernel bandwidth
